...
void StyleDarkAndPurple()
{
  ...
  colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.57f, 0.28f, 0.76f, 0.40f);
  colors[ImGuiCol_FrameBgActive]          = ImVec4(0.57f, 0.28f, 0.76f, 0.40f);
  ...
  colors[ImGuiCol_CheckMark]              = ImVec4(0.57f, 0.28f, 0.76f, 0.40f);
  colors[ImGuiCol_SliderGrab]             = ImVec4(0.57f, 0.28f, 0.76f, 0.40f);
  colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.60f, 0.36f, 0.76f, 0.40f);
  colors[ImGuiCol_Button]                 = ImVec4(0.36f, 0.38f, 0.39f, 1.00f);
  colors[ImGuiCol_ButtonHovered]          = ImVec4(0.57f, 0.28f, 0.76f, 1.00f);
  colors[ImGuiCol_ButtonActive]           = ImVec4(0.57f, 0.28f, 0.76f, 1.00f);
  ...
  colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.57f, 0.28f, 0.76f, 1.00f);
  colors[ImGuiCol_SeparatorActive]        = ImVec4(0.57f, 0.28f, 0.76f, 1.00f);
  colors[ImGuiCol_ResizeGrip]             = ImVec4(0.36f, 0.38f, 0.39f, 1.00f);
  colors[ImGuiCol_ResizeGripHovered]      = ImVec4(0.57f, 0.28f, 0.76f, 1.00f);
  colors[ImGuiCol_ResizeGripActive]       = ImVec4(0.57f, 0.28f, 0.76f, 1.00f);
  colors[ImGuiCol_PlotLines]              = ImVec4(0.61f, 0.61f, 0.61f, 1.00f);
  colors[ImGuiCol_PlotLinesHovered]       = ImVec4(0.60f, 0.36f, 0.76f, 0.40f);
  colors[ImGuiCol_PlotHistogram]          = ImVec4(0.57f, 0.28f, 0.76f, 1.00f);
  colors[ImGuiCol_PlotHistogramHovered]   = ImVec4(0.60f, 0.36f, 0.76f, 1.00f);
